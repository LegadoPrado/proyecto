...
public class API_ArbSer implements Response.Listener<JSONObject>, Response.ErrorListener {
    ...
    private String URL1 = "http://192.168.50.100:8081/MuestraArbolServiciosAparatosPorinstalar/GetMuestraArbolServiciosAparatosPorinstalarList";
    ...
    public API_ArbSer(Context contexto, View view) {
