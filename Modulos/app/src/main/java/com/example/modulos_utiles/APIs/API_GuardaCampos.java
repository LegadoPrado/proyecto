...
public class API_GuardaCampos implements Response.Listener<JSONObject>, Response.ErrorListener {
    ...
    private String URL = "http://192.168.50.100:8082/SoftvWCFService.svc/Quejas/UpdateQuejas";
    private String token;
    private String usuario;

    public API_GuardaCampos(Context contexto) {
    ...
    public void onResponse(JSONObject response) {
        ...
        try {
            response1 = response.getString("UpdateQuejasResult");
