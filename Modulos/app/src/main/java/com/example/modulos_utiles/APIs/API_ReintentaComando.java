...
public class API_ReintentaComando implements Response.Listener<JSONObject>, Response.ErrorListener {
    ...
    private String URL = "http://192.168.50.100:8082/SoftvWCFService.svc/OrdSer/GetReintentarComando";
    private String token;
    private String usuario;

    public API_ReintentaComando(Context contexto) {
    ...
    public void onResponse(JSONObject response) {
        Toast.makeText(contexto, "ReintentaRequest", Toast.LENGTH_SHORT).show();
