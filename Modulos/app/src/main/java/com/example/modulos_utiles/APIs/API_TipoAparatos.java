...
public class API_TipoAparatos   implements Response.Listener<JSONObject>, Response.ErrorListener {
    ...
    public API_TipoAparatos(Context contexto, View view) {
    ...
    private void API_DatosCambioAP() throws JSONException {
        ...
        clv_Tecnico.put("Id", 0);
        clv_Tecnico.put("obj", 0);

        JSONObject clv_Tecnico1= new JSONObject();

        clv_Tecnico1.put("obj", 0);

        JSONObject clv_Tecnico3= new JSONObject();
        clv_Tecnico3.put("obj", 0);
        clv_Tecnico3.put("LIst", 0);
