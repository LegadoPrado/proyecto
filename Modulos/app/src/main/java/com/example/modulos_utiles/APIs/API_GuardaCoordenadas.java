...
public class API_GuardaCoordenadas implements Response.Listener<JSONObject>, Response.ErrorListener {
    ...
    private String URL = "http://192.168.50.100:8082/SoftvWCFService.svc/CLIENTES_New/GetGuardaCoordendasCli";
    private String token;
    private String usuario;

    public API_GuardaCoordenadas(Context contexto) {
